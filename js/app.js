(() => {
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".tabs-tools__slider")) {
                new core(".tabs-tools__slider--1", {
                    ...
                    speed: 800,
                    pagination: {
                        el: ".tabs-tools__pagination--1",
                        clickable: true
                    },
                    on: {}
                });
                new core(".tabs-tools__slider--2", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    speed: 800,
                    pagination: {
                        el: ".tabs-tools__pagination--2",
                        clickable: true
                    },
                    on: {}
                });
                new core(".tabs-tools__slider--3", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
        ...
        window.addEventListener("load", (e => {
            const languagesBtn = document.querySelector(".languages-header__current");
            if (languagesBtn) {
                languagesBtn.addEventListener("click", (e => {
                    languagesBtn.parentElement.classList.toggle("_active");
                }));
                window.addEventListener("click", (e => {
                    const target = e.target;
                    !target.closest(".actions-header__languages") ? languagesBtn.parentElement.classList.remove("_active") : "";
                }));
            }
        }));
        const obj = {
        ...
        const entries = [ [ "name", "Vladilen" ], [ "age", 26 ], [ "job", "Fullstack" ] ];
        ...
        const set = new Set([ 1, 2, 3, 3, 3, 6, 6, 8, 7 ]);
        console.log(set);
        function unifyValues(array) {
            return [ ...new Set(array) ];
        }
        console.log(unifyValues([ 1, 22, 22, 22, 22, 562, 1, 22, 22, 7, 7, 7, 7, 7 ]));
        window["FLS"] = false;
        isWebp();
        menuInit();
        spollers();
